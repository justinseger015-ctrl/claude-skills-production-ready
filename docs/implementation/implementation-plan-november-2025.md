...
├── skills/marketing-team/          # EXISTING - unchanged
├── skills/engineering-team/          # EXISTING - unchanged
├── skills/product-team/             # EXISTING - unchanged
├── skills/delivery-team/       # EXISTING - unchanged
├── skills/engineering-team/         # EXISTING - unchanged
...
4. **documentation-standards.md** → `standar./`
   - Markdown formatting
...
python ../../skills/marketing-team/content-creator/scripts/seo_optimizer.py article.md "primary keyword" "secondary,keywords"
```

### Knowledge Bases

- Brand Guidelines: `../../skills/marketing-team/content-creator/references/brand_guidelines.md`
- Content Frameworks: `../../skills/marketing-team/content-creator/references/content_frameworks.md`
- Social Media Optimization: `../../skills/marketing-team/content-creator/references/social_media_optimization.md`

### Templates

- Content Calendar: `../../skills/marketing-team/content-creator/assets/content-calendar-template.md`
- Brand Voice Checklist: `../../skills/marketing-team/content-creator/assets/brand-voice-checklist.md`
...
python ../../skills/marketing-team/content-creator/scripts/seo_optimizer.py draft.md "content marketing"
...
python ../../skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py sample1.txt json > voice1.json
python ../../skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py sample2.txt json > voice2.json
python ../../skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py sample3.txt json > voice3.json
...
- Skill Documentation: `../../skills/marketing-team/content-creator/SKILL.md`
...
- Integrates with `../../skills/marketing-team/marketing-demand-acquisition/`
...
**Integration Points:**
- Skill: `../../skills/engineering-team/ceo-advisor/`
...
**Integration Points:**
- Skill: `../../skills/engineering-team/cto-advisor/`
...
**Integration Points:**
- Skill: `../../skills/product-team/product-manager-toolkit/`
...
python ../../skills/product-team/product-manager-toolkit/scripts/rice_prioritizer.py features.csv --capacity 20 --output json
...
2. **Agent Creation Guide:** `docs/AGENT_CREATION_GUIDE.md`
...
- Checklist:
  ...
  - [ ] Test relative paths to skills/marketing-team/
...
- Checklist:
  ...
  - [ ] Test relative paths to skills/engineering-team/
  - [ ] Validate Python tool invocation
...
- Checklist:
  ...
  - [ ] Test relative paths to skills/product-team/
...
- Checklist:
  ...
  - [ ] Create docs/AGENT_CREATION_GUIDE.md
...
├── skills/marketing-team/          # EXISTING
├── skills/engineering-team/          # EXISTING
├── skills/product-team/             # EXISTING
├── skills/delivery-team/       # EXISTING
├── skills/engineering-team/         # EXISTING
├── ra-qm-team/               # EXISTING
├── CLAUDE.md
├── README.md
