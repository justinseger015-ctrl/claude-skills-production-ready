...
4. **documentation-standards.md** (30 min)
   ```bash
   # Source: factory/.claude/standar./
   # Target: standar./documentation-standards.md
   ```
   - Markdown formatting
...
# Test relative paths
cd agents/marketing
ls ../../skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py
ls ../../skills/marketing-team/content-creator/references/brand_guidelines.md

# Test Python tool execution
python ../../skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py \
...
- YAML frontmatter
- Skill integration: `../../skills/marketing-team/marketing-demand-acquisition/`
...
**Structure:**
- YAML frontmatter
- Skill integration: `../../skills/engineering-team/ceo-advisor/`
...
**Structure:**
- YAML frontmatter
- Skill integration: `../../skills/engineering-team/cto-advisor/`
...
**Structure:**
- YAML frontmatter
- Skill integration: `../../skills/product-team/product-manager-toolkit/`
...
**File 2:** `docs/AGENT_CREATION_GUIDE.md`
...
git add docs/AGENT_CREATION_GUIDE.md
...
cd ../c-level
ls ../../skills/engineering-team/ceo-advisor/scripts/
...
python skills/marketing-team/content-creator/scripts/brand_voice_analyzer.py CLAUDE.md

python skills/marketing-team/content-creator/scripts/seo_optimizer.py README.md "claude skills"
...
- **Implementation Plan:** `docs/implementation/implementation-plan-november-2025.md`
- **Sprint Context:** `docs/delivery/sprint-11-05-2025/context.md`
