...
| **Scope** | 43 Pandora-focused skills | 29 production agents |
...
Test-Driven Development specialist for Red-Green-Refactor workflows, specification-first design, and emergent architecture through iterative test cycles.

**Key Workflows:**
- Feature Development via Red-Green-Refactor
- API Design via Contract-First TDD
- Legacy Code Refactoring with TDD Safety Net
- TDD Project Setup

**Python Tools Used:**
- `tdd_workflow.py` - Red-Green-Refactor cycle orchestration
- `fixture_generator.py` - Test data and boundary value generation
- `format_detector.py` - Test framework auto-detection
- `test_spec_generator.py` - Given-When-Then spec generation
- `refactor_analyzer.py` - Refactoring safety analysis

[View Agent →](../agents/engineering/cs-tdd-engineer.md)
...
### 📝 cs-technical-writer
**Domain:** Engineering | **Skills Used:** technical-writer

Documentation quality, README generation, CHANGELOG maintenance, and API documentation. Readability analysis with Flesch-Kincaid and Gunning Fog metrics.
...
**Python Tools Used:**
- `doc_quality_analyzer.py` - Quality scoring with readability metrics
- `readme_generator.py` - Template-based README generation
- `changelog_generator.py` - Conventional commit parsing
- `api_doc_formatter.py` - Multiple output formats

[View Agent →](../agents/engineering/cs-technical-writer.md)
