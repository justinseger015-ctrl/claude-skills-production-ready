...
### Domain Guides
- **skills/marketing-team/README.md** - Marketing team guide (957 lines)
- **skills/product-team/README.md** - Product team guide (if exists)
- **skills/delivery-team/README.md** - PM team guide (974 lines)
- **skills/engineering-team/START_HERE.md** - Engineering quick start (355 lines)
- **skills/engineering-team/TEAM_STRUCTURE_GUIDE.md** - Team composition (631 lines)
- **ra-qm-team/README.md** - Regulatory/Quality guide (489 lines)

### Technical Documentation
- **docs/implementation/SKILLS_REFACTORING_PLAN.md** - Anthropic optimization plan
- **docs/PYTHON_TOOLS_AUDIT.md** - Tools quality assessment
