...
Hey Claude—I just added the "ux-researcher-designer" skill. Can you help me with [describe your task]?

## Example Invocations

### Example 1: Basic Usage
```
Hey Claude—I just added the "ux-researcher-designer" skill. Can you [specific task related to this skill]?
```

### Example 2: Advanced Usage
```
Hey Claude—I just added the "ux-researcher-designer" skill. Can you [more complex task with specific requirements]?
```

### Example 3: Integration with Other Skills
```
Hey Claude—I just added the "ux-researcher-designer" skill. Can you use it together with [another skill] to [combined task]?
```
...
- **Deliverables**: persona_generator.py

## Python Tools Available

This skill includes the following Python tools:

- **persona_generator.py**: Persona Generator functionality

You can also run these tools directly:

```bash
python scripts/persona_generator.py --help
```
...
4. **Combine Skills**: This skill works well with other ux-research skills
