...
Hey Claude—I just added the "content-creator" skill. Can you help me with [describe your task]?

## Example Invocations

### Example 1: Basic Usage
```
Hey Claude—I just added the "content-creator" skill. Can you [specific task related to this skill]?
```

### Example 2: Advanced Usage
```
Hey Claude—I just added the "content-creator" skill. Can you [more complex task with specific requirements]?
```

### Example 3: Integration with Other Skills
```
Hey Claude—I just added the "content-creator" skill. Can you use it together with [another skill] to [combined task]?
```
...
- **Deliverables**: brand_voice_analyzer.py, seo_optimizer.py

## Python Tools Available

This skill includes the following Python tools:

- **brand_voice_analyzer.py**: Brand Voice Analyzer functionality
- **seo_optimizer.py**: Seo Optimizer functionality
...
4. **Combine Skills**: This skill works well with other content-marketing skills
