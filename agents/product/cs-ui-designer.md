...
**Skill Location:** `../../product-team/ui-design-system/`
...
1. **Design Token Generator**
   ...
   - **Usage:** `python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format css`
...
1. **Design System Principles**
   - **Location:** `../../product-team/ui-design-system/references/design_system_principles.md`
...
2. **Component API Guidelines**
   - **Location:** `../../product-team/ui-design-system/references/component_api_guidelines.md`
...
3. **Design Token Standards**
   - **Location:** `../../product-team/ui-design-system/references/design_token_standards.md`
...
1. **Design System Starter Kit**
   - **Location:** `../../product-team/ui-design-system/assets/design-system-starter.md`
   - **Use Case:** New design system kickoff, foundational setup

2. **Component Documentation Template**
   - **Location:** `../../product-team/ui-design-system/assets/component-doc-template.md`
...
2. **Define Token Architecture** - Structure token system:
   ```bash
   cat ../../product-team/ui-design-system/references/design_token_standards.md | grep -A 20 "Token Taxonomy"
   ```
...
4. **Generate Platform-Specific Tokens** - Export for all platforms:
   ```bash
   # CSS Variables
   python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format css > tokens.css

   # SCSS Variables
   python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format scss > _tokens.scss

   # JavaScript/TypeScript
   python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format json > tokens.json

   # iOS (Swift)
   python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format ios > DesignTokens.swift

   # Android (XML)
   python ../../product-team/ui-design-system/scripts/design_token_generator.py tokens.json --format android > design_tokens.xml
   ```
...
python ../../product-team/ui-design-system/scripts/design_token_generator.py design-tokens.json --format css
python ../../product-team/ui-design-system/scripts/design_token_generator.py design-tokens.json --format json
python ../../product-team/ui-design-system/scripts/design_token_generator.py design-tokens.json --format ios
```
...
1. **Plan Component Hierarchy** - Structure component library:
   ```bash
   cat ../../product-team/ui-design-system/references/design_system_principles.md | grep -A 30 "Atomic Design"
   ```
...
2. **Define Component API** - Design consistent component interfaces:
   ```bash
   cat ../../product-team/ui-design-system/references/component_api_guidelines.md | head -40
   ```
...
6. **Document Components** - Create comprehensive documentation:
   ```bash
   cp ../../product-team/ui-design-system/assets/component-doc-template.md docs/button.md
   ```
...
5. **Create Contribution Guidelines** - Enable team contributions:
   ```bash
   cat ../../product-team/ui-design-system/assets/design-system-starter.md | grep -A 20 "Contributing"
   ```
...
2. **Use Design Tokens in Figma** - Sync design and code tokens:
   ```bash
   # Export Figma tokens
   python ../../product-team/ui-design-system/scripts/design_token_generator.py figma-export.json --format css > tokens.css
   ```
...
python ../../product-team/ui-design-system/scripts/design_token_generator.py "$TOKENS_FILE" --format css > dist/css/tokens.css
echo "   ✅ Generated: dist/css/tokens.css"

# Generate SCSS Variables
echo "2. Generating SCSS Variables..."
python ../../product-team/ui-design-system/scripts/design_token_generator.py "$TOKENS_FILE" --format scss > dist/scss/_tokens.scss
echo "   ✅ Generated: dist/scss/_tokens.scss"

# Generate JavaScript/JSON
echo "3. Generating JavaScript Tokens..."
python ../../product-team/ui-design-system/scripts/design_token_generator.py "$TOKENS_FILE" --format json > dist/js/tokens.json
echo "   ✅ Generated: dist/js/tokens.json"

# Generate iOS (Swift)
echo "4. Generating iOS Tokens..."
python ../../product-team/ui-design-system/scripts/design_token_generator.py "$TOKENS_FILE" --format ios > dist/ios/DesignTokens.swift
echo "   ✅ Generated: dist/ios/DesignTokens.swift"

# Generate Android (XML)
echo "5. Generating Android Tokens..."
python ../../product-team/ui-design-system/scripts/design_token_generator.py "$TOKENS_FILE" --format android > dist/android/design_tokens.xml
...
cat ../../product-team/ui-design-system/references/design_system_principles.md | grep "^## " | head -5
...
echo "   - Principles: ../../product-team/ui-design-system/references/design_system_principles.md"
echo "   - Component API: ../../product-team/ui-design-system/references/component_api_guidelines.md"
echo "   - Token Standards: ../../product-team/ui-design-system/references/design_token_standards.md"
```
...
cp ../../product-team/ui-design-system/assets/component-doc-template.md "$COMPONENT_FILE"
...
- **Skill Documentation:** [../../product-team/ui-design-system/SKILL.md](../../product-team/ui-design-system/SKILL.md)
