...
- [Documentation Standards](documentation/documentation-standards.md) - How to document CLIs
...
2. Check existing implementations: Look at `product-team/product-manager-toolkit/scripts/rice_prioritizer.py`
